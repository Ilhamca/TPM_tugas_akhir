...
class AppColors {
  ...
  static const Color bg = Color(0xFFF8FAFC);            // Latar belakang aplikasi (abu-abu sangat muda)
  static const Color cardBg = Color(0xFFFFFFFF);        // Latar belakang kartu
  static const Color textPrimary = Color(0xFF334155);   // Teks abu-abu gelap, lebih nyaman dari hitam #000000
  ...
  static const Color link = Color(0xFF2563EB);         // Biru yang lebih cerah untuk tautan
